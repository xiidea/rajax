 ...
 * Mobile: 01817087873
 * http://www.helpful-roni.com/projects/js/rajax.html
 *
...
(function(){
    ...
    */
    ...
    SFileInput.prototype = {
		...
		_moveImputToForm:function(){
			var self=this;			
			if(self._settings.multipleFile)return;
			if(self._input){				
				...
				self._form.appendChild(tempinput);
			}else{
		...
		_validate:function(){
			var self=this;
			if(self._settings.multipleFile && self._settings.required){	//Special checking required
			alert(self.fileselected);
				return (self.fileselected>0)
			}else if(self._settings.required){
				alert(self.fileselected)
	...
	rajax.prototype = {
        ...
        post: function(){  
			...
			for (var i in this.sfinputs){
				...
				this.sfinputs[i]._moveImputToForm();
			}
